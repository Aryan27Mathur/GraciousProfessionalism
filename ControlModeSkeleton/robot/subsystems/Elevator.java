...
public class Elevator extends UpDownSubsystem
{
	...
	private static final double	ELEVATOR_VELOCITY		= 2 * TICKS_PER_REV;
	...
	public void setElevatorPos(double stickVal) 
	{
		m_elevator.set(ControlMode.Velocity, stickVal * ELEVATOR_VELOCITY);
	}
